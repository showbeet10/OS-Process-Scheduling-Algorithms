...
#         p['wt'] = p['tat'] - p['burst']
#         gantt_chart.append((p['pid'], start, time))
...
# # GUI Layout
# window = tk.Tk()
# window.title("CPU Scheduler Simulator")

# tk.Label(window, text="Enter Process Data (PID AT BT):").pack()
# text_input = tk.Text(window, height=6, width=40)
# text_input.pack()

# tk.Button(window, text="Run FCFS Scheduler", command=run_scheduler).pack()
